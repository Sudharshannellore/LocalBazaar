...
function VendorOrderHistory() {
  ...
  const fetchOrderHistory = async () => {
    try {
      const response = await axios.get('https://localbazaar.onrender.com/user/order/history', {
        headers: {
  ...
  return (
    <div>
      <Navbar/>
      <br />
    <h1 className=" pl-6 text-2xl font-bold mb-4 text-gray-800">Order History</h1>
